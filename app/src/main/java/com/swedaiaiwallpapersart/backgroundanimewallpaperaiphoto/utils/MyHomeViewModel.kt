...
class MyHomeViewModel @Inject constructor(
    private val getTrendingWallpaperUseCase: GetTrendingWallpaperUseCase,
    private val getAllLikesUsecase: GetAllLikesUsecase,
    private val getAllLikedUseCase: GetAllLikedUseCase
) : ViewModel() {
    ...
    fun fetchWallpapers(context: Context, animation: LottieAnimationView, page: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val service = retrofit.create(HomeListInterfaceWithId::class.java)
                .getList(MySharePreference.getDeviceID(context)!!, page)
    ...
    private var _trendingWallpapers =
    ...
    val trendingWallpapers: LiveData<com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response<List<SingleDatabaseResponse>>> =
        _trendingWallpapers
    ...
    private var _allLikes =
        MutableLiveData<com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response<ArrayList<LikesResponse>>>(
            com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response.Success(
                arrayListOf()
            )
        )
    val allLikes: LiveData<com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response<ArrayList<LikesResponse>>> =
        _allLikes
    ...
    private var _allLiked =
        MutableLiveData<com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response<ArrayList<LikedResponse>>>(
            com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response.Success(
                arrayListOf()
            )
        )
    val allLiked: LiveData<com.swedaiaiwallpapersart.backgroundanimewallpaperaiphoto.utils.Response<ArrayList<LikedResponse>>> =
        _allLiked
