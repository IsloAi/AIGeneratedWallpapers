...
class FavouriteStaticAdapter(
    private var list: MutableList<SingleDatabaseResponse>,
    ...
    inner class ViewHolder(val binding: WallpaperRowBinding) :
        ...
        fun bind(item: SingleDatabaseResponse) {
    ...
    private fun setAllData(
        adapterPosition: Int,
        item: SingleDatabaseResponse,
        binding: WallpaperRowBinding
    ) {
    ...
    fun updateData(newList: List<SingleDatabaseResponse>) {
