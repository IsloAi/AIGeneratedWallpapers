...
class PopularSliderAdapter(private val welcomeItems: List<Int>, var positionCallback: joinButtons) :
    RecyclerView.Adapter<PopularSliderAdapter.SliderViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SliderViewHolder {
        val binding =
            ListItemPopularSliderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class SliderViewHolder(val binding: ListItemPopularSliderBinding) :
