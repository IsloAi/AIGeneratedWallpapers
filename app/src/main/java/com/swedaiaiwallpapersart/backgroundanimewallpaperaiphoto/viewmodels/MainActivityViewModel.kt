...
class MainActivityViewModel @Inject constructor(
    ...
    private var _allModels =
        MutableLiveData<Response<ArrayList<SingleAllResponse>>>(Response.Success(null))
    val allModels: LiveData<Response<ArrayList<SingleAllResponse>>> = _allModels


    private var _updates =
        MutableLiveData<Response<ArrayList<SingleAllResponse>>>(Response.Success(null))
    val updates: LiveData<Response<ArrayList<SingleAllResponse>>> = _updates


    private var _mostUsed =
        MutableLiveData<Response<ArrayList<MostDownloadedResponse>>>(Response.Success(null))
